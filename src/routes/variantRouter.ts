...
variantRouter.get('/getAllVariant', variantController.getAllVariant.bind(variantController));
variantRouter.get('/getAllWithoutPrice', variantController.getAllVariantWithoutPrice.bind(variantController));
...
variantRouter.get('/newest/:number', variantController.getNewEst.bind(variantController));
variantRouter.get('/top_selling/:number', variantController.getTopSelling.bind(variantController));
