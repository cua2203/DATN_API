...
importRouter.post(
  '/getByDate',
  orderController.getByDate.bind(orderController),
);
importRouter.get(
  '/detail/:id',
  orderController.getImportBillDetail.bind(orderController),
);
importRouter.post(
  '/total',
  orderController.totalImportPrice.bind(orderController),
);
